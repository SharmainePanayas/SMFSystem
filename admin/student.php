...
<body>
	...
	<div id = "content">
		<br /><br /><br />
		<div style="color:black;" class="alert alert-info"><h3><b> Student</b></h3></div> 
		...
		<table id = "table" class="table table-bordered">
			...
			<tbody>
				<?php
					$query = mysqli_query($conn, "SELECT * FROM student NATURAL JOIN storage WHERE student.stud_no = storage.stud_no;") or die(mysqli_error());
						...
						<div class="col-md-6">
							...
							<div class="form-inline">
								...
								<select name="section" class="form-control" required="required">
									<option value=""></option>
									<option value="A">IT11S1</option>
									<option value="B">IT21S2</option>
									<option value="C">IT31S3</option>
									<option value="D">IT41S4</option>
								</select>
							</div>
							<br />
							<div class="form-group">
