...
<div class="col-md-3">
	<div class="panel panel-primary" id="panel-margin" style="background-color:#ffd700;">
		...
		<div class="panel-body">
			<form method="POST">
				...
				<div class="form-group">
					<button class="btn btn-block btn-primary"  name="login" style="background-color:black;"><span class="glyphicon glyphicon-log-in"></span> Login</button>
				</div>
			</form>
		</div>
	</div>
